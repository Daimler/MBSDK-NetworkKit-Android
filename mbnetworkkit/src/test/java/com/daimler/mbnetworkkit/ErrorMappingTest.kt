...
class ErrorMappingTest {
    ...
    fun testDefaultHttpErrorMapping() {
        ...
        val error = defaultErrorMapping(BaseRetrofitTask.ResponseException(400, null, null))
        val error2 = defaultErrorMapping(BaseRetrofitTask.ResponseException(400, null, error2Body))
        val error3 = defaultErrorMapping(BaseRetrofitTask.ResponseException(400, null, error3Body))
    ...
    fun testCustomErrorMapping() {
        ...
        val errorResponse = BaseRetrofitTask.ResponseException(400, null, errorsJson)
