...
abstract class SocketConnection(
    ...
    public fun unregisterListener(socketConnectionListener: SocketConnectionListener) {
        removeListenerIfRegistered(socketConnectionListener)
    }

    public fun connectToSocket(config: ConnectionConfig, socketConnectionListener: SocketConnectionListener? = null) {
    ...
    public fun connectionState(): ConnectionState = socketState.connectionState()
